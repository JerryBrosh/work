<template>
  <div class="dept">
    ...
    <el-table :data="deptData" height="550" border style="width: 100%">
      ...
      <el-table-column prop="DeptName" label="部门地址"></el-table-column>
      <el-table-column prop="DeptDescript" label="描述"></el-table-column>
      ...
      <el-table-column prop="CreateDate" :formatter="DateHandler" label="创建时间"></el-table-column>
    ...
    addDept: function () {
      this.$axios
        .post("/api/addDept", {
          ...
          deptDescript: this.form.descript,
        })
        .then((response) => {
